@extends('layouts.app')
@section('content')
<h1 class="text-xl font-semibold mb-3">Barang Keluar</h1>
<form method="post" action="{{ route('stock.out.store') }}" class="bg-white p-4 rounded-xl shadow">@csrf
  ...
  <button class="px-3 py-2 bg-red-600 text-white rounded">Simpan</button>
</form>
@endsection
